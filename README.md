# PrintZone — інтернет-магазин витратних матеріалів для друку (E-Commerce)
...
> 📄 **Звіт (Task 27)** — SOA-декомпозиція: аналіз компонентів, межі сервісів, OpenAPI-контракти, планування комунікації з мапінгом «вимога → артефакт»: [`docs/task-27-decomposition-report.md`](docs/task-27-decomposition-report.md).
