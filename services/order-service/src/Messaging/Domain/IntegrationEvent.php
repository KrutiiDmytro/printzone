 ...
 *
 * The FQCN is intentionally identical to the monolith's and catalog-service's
 * copy: it travels in the message `type` header so every service deserializes
 * the JSON back into its own matching class.
 */
